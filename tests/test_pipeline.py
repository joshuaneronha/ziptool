...
from ziptool import data_by_zip, fetch_data, geo_conversion, load
...
def test_zip_to_tract():
    ...
    assert pvd_east_test[0] == [
        [44007003200.0, 0.120752911150103],
    ...
    assert ancorage_test[0] == [
        [2020000500.0, 0.111827733277852],
...
def test_data_by_zip():
    ...
    test_results = data_by_zip.data_by_zip(
        ["02835", "45103"],
        test_data,
        {
